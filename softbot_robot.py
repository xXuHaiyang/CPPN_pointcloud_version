...
class SoftbotRobot(MOORobotInterface):
    ...
    # a function to determine whether the points in test_split is one specific shape
    ...
    def compute_work(self, test=True, **kwargs):
        ...
        test_split = cppn_morphology[0]
        
        self.fitnesses[0] = self.sphere_test_score(test_split)
        self.fitnesses[1] = 0
